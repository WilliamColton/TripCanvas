...
public interface TaskDtoMapper {
    ...
    @Mapping(target = "templateQualityId", expression = "java(emptyToNull(task.templateQualityId()))")
    @Mapping(target = "templateQualityName", expression = "java(emptyToNull(task.templateQualityName()))")
    ...
    @Mapping(target = "templateQualityId", expression = "java(emptyToNull(entity.getTemplateQualityId()))")
    @Mapping(target = "templateQualityName", expression = "java(emptyToNull(entity.getTemplateQualityName()))")
